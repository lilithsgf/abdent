...
let elementos = document.querySelectorAll(".titulo, #contenedor-parrafo ,.parrafo-imagen-lista, .btn-wsp, #beneficios2, .parrafo-imagen-lista2, .titulo-preguntas, .contenedor-preguntas");
