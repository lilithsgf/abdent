...
document.addEventListener("DOMContentLoaded", function () {
    setTimeout(() => {
        ...
        document.getElementById("img-implantologia-princi").classList.add("show");
        document.getElementById("titulo-principal1").classList.add("show");
        document.getElementById("parrafo1").classList.add("show");
        document.getElementById("parrafo2").classList.add("show");
...
let elementos = document.querySelectorAll(".contenedor-parrafo,.parrafo-imagen-lista, .btn-wsp,.titulo-cuadros, .titulo-preguntas, .padre-contenedor-pregunta ");
