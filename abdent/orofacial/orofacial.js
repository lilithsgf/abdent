...
let elementos = document.querySelectorAll(".titulo, .contenedor-parrafo,.parrafo-imagen-lista1,#beneficios, .parrafo-imagen-lista,.btn-wsp, .titulo-preguntas , .contenedor-preguntas");
